...
import com.storyappsubmission1.ViewModel.FactoryVM
import com.storyappsubmission1.ViewModel.LoginVM
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupView() {
        ...
        if (!intent.getStringExtra("password").isNullOrEmpty()) {
            binding.passwordEditText.setText(intent.getStringExtra("password"))
        }
    }
                        ...
                        override fun onResponse(call: Call<LoginR>, response: Response<LoginR>) {
                            ...
                            if (response.isSuccessful && responseBody != null) {
                                ...
                                if (responseBody.error) {
                                    ...
                                    Toast.makeText(
                                        this@LoginActivity,
                                        "Login Berhasilic_baseline_email_24.xml\n" +
    ...
    private fun playAnimation() {
        ...
        val passwordEditTextLayout =
            ObjectAnimator.ofFloat(binding.edPassword, View.ALPHA, 1f).setDuration(500)
