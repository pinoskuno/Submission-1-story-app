package com.storyappsubmission1.Data.Adapter
...
class StoryAdapter (private val Story: ArrayList<ListStoryR>):
    ...
    class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private var StoryPhoto: ImageView = itemView.findViewById(R.id.iv_detail_photo)
        private var tvStoryName: TextView = itemView.findViewById(R.id.tv_detail_name)
        private var tvStoryDate: TextView = itemView.findViewById(R.id.tv_detail_post)
